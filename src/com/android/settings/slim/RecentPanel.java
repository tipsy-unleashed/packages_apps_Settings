...
public class RecentPanel extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private void updateRecentsLocation(int value) {
        ...
        if (value == 0) {
            ...
            Settings.System.putInt(getContentResolver(), Settings.System.RECENTS_CLEAR_ALL_LOCATION, 1);
            summary = R.string.recents_clear_all_location_top_left;
        } else if (value == 2) {
            Settings.System.putInt(getContentResolver(), Settings.System.RECENTS_CLEAR_ALL_LOCATION, 2);
            summary = R.string.recents_clear_all_location_top_center;
        } else if (value == 3) {
            Settings.System.putInt(getContentResolver(), Settings.System.RECENTS_CLEAR_ALL_LOCATION, 3);
            summary = R.string.recents_clear_all_location_bottom_right;
        } else if (value == 4) {
            Settings.System.putInt(getContentResolver(), Settings.System.RECENTS_CLEAR_ALL_LOCATION, 4);
            summary = R.string.recents_clear_all_location_bottom_left;
        } else if (value == 5) {
            Settings.System.putInt(getContentResolver(), Settings.System.RECENTS_CLEAR_ALL_LOCATION, 5);
